...
namespace Core.RabbitNotification
{
    ...
    {
        void OpenChannel(string channelId, string prevChannelId, string transactionId, string assetId, string hubAddress, string clientAddress1, string clientAddress2);
