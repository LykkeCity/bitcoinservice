...
namespace Lykke.Bitcoin.Api.Client.AutoGenerated
{
    ...
    public partial interface IBitcoinApi : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiBccBalanceGetWithHttpMessagesAsync(string address = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiEnqueueTransactionCashoutPostWithHttpMessagesAsync(CashoutRequest model = default(CashoutRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiEnqueueTransactionSegwitTransferPostWithHttpMessagesAsync(SegwitTransferRequest model = default(SegwitTransferRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiOffchainFullcashoutPostWithHttpMessagesAsync(CreateCashoutModel model = default(CreateCashoutModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiOffchainCashouthubPostWithHttpMessagesAsync(CreateCashoutModel model = default(CreateCashoutModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiWalletSegwitByClientPubKeyGetWithHttpMessagesAsync(string clientPubKey, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> ApiWalletSegwitGetWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
